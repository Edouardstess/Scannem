...
216 tests, 562 assertions, aucune dépendance externe. Les tests critiques
vérifient notamment :
...
| Mot de passe oublié : réinitialisation par fichier FTP, fichier détruit | `PasswordRecoveryTest` |
